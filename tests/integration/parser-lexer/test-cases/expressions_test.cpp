...
TEST_F(TestParserLexer, expressions)
{
    ...
    EXPECT_TRUE(ERROR_HANDLER.contains({ERROR, MISSING_BOTH_SUB_OPERANDS, 80, {"print"}}));
    ...
    EXPECT_TRUE(ERROR_HANDLER.contains({ERROR, MISSING_BOTH_SUB_OPERANDS  , 82, {"-"}}));
    ...
    EXPECT_TRUE(ERROR_HANDLER.contains({ERROR, MISSING_BOTH_SUB_OPERANDS  , 84, {"-"}}));
