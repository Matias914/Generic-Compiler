...
#define MISSING_ARGUMENT               32
#define MISSING_RIGHT_SIDE_VALUES      33
#define MISSING_POINTED_PARAMETER      34
#define MISSING_ENDIF                  35
#define MISSING_IF_EXECUTABLE_BODY     36
#define MISSING_ELSE_EXECUTABLE_BODY   37
#define MISSING_BOTH_EXECUTABLE_BODY   38
#define MISSING_IF_STATEMENT           39
#define MISSING_WHILE                  40
#define MISSING_WHILE_EXECUTABLE_BODY  41
#define MISSING_COMPARISON_OPERATOR    42
#define MISSING_EXPRESSION_OPERATOR    43
#define MISSING_RIGHT_OPERAND          44
#define MISSING_LEFT_OPERAND           45
#define MISSING_BOTH_OPERANDS          46
#define MISSING_FLOAT_CONSTANT         47
#define MISSING_RIGHT_FACTOR           48
#define MISSING_LEFT_FACTOR            49
#define MISSING_BOTH_FACTORS           50
